...
export async function GET(_req, { params }) {
  ...
  const [messages, interps, owners, review] = await Promise.all([
  ...
  return Response.json({ issue, messages: messages.data || [], replies: interps.data || [], owners: owners.data || [], review: review.data || [], people: people || [] });
}
