// Template-first messaging keeps Claude costs near zero.
// {name}, {campaign}, {issue}, {n} get slotted in.

export function outreachSubject(c) {
  return `[Action Required] ${c.campaign ? c.campaign + " — " : ""}data correction needed`;
}
